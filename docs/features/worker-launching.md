...
Agent, command, and script steps also receive `ORC_PROJECT_ROOT`,
`ORC_ATTEMPT_STARTED_AT`, `ORC_ATTEMPT_DEADLINE`, and
`ORC_ATTEMPT_TIMEOUT`. These values support `orc time-left` and Codex
PostToolUse hook nudges. See
